...
def data():
    ...
    print(
        f"{namevalue.get(), phonevalue.get(), gendervalue.get(), emargencyvalue.get(), paymentvalue.get(), foodservicevalue.get()}"
    )
...
Button(text="Reset", command=reset).grid(row=7, column=3)
